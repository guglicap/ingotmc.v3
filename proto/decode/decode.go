// Package decode implements functions to deserialize minecraft protocol datatypes.
// This only makes sense for types that aren't to change across minecraft versions, so packet decoding doesn't belong here.
